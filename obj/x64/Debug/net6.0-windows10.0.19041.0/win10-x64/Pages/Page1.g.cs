#pragma checksum "C:\Users\Admin\source\repos\better_power\Pages\Page1.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "25FCA9F758A81BD54AE8A8FC2019D5C627E6CB109B52BCB2C5F45B9C4058AF3B"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IPage1_Bindings
        {
            ...
            private void Update_(global::better_power.SettingStore obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ac_value(obj.curr_ac_val, phase);
                    }
                }
            }
            ...
            IPage1_Bindings
        {
            ...
            private void Update_(global::better_power.SettingStore obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_index_dict(obj.possible_settings_index_dict, phase);
                    }
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ac_value(obj.curr_ac_val, phase);
