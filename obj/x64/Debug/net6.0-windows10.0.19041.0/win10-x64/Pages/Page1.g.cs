            ...
            IPage1_Bindings
        {
            ...
            private void Update_(global::better_power.SettingStore obj, int phase)
            {
                if (obj != null)
                {
                    ...
                    {
                        this.Update__setting_current_vals(obj._setting_current_vals, phase);
                    }
                }
            }
            private void Update__setting_current_vals(global::better_power.current_vals obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update__setting_current_vals_ac_value(obj.ac_value, phase);
                    }
                }
            }
            private void Update__setting_current_vals_ac_value(global::System.Int32 obj, int phase)
            {
            ...
            private void UpdateTwoWay_3_Value()
            {
                if (this.initialized)
                {
                    ...
                    {
                        if (this.dataRoot._setting_current_vals != null)
                        {
                            this.dataRoot._setting_current_vals.ac_value = (global::System.Int32)(this.obj3.Target as global::Microsoft.UI.Xaml.Controls.NumberBox).Value;
                        }
                    }
                }
            }
            ...
            IPage1_Bindings
        {
            ...
            private void Update_(global::better_power.SettingStore obj, int phase)
            {
                if (obj != null)
                {
                    ...
                    {
                        this.Update__setting_possible_vals(obj._setting_possible_vals, phase);
                    }
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update__setting_current_vals(obj._setting_current_vals, phase);
            ...
            private void Update__setting_possible_vals(global::better_power.possible_vals obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update__setting_possible_vals_index_dict(obj.index_dict, phase);
                    }
                }
            }
            private void Update__setting_possible_vals_index_dict(global::System.Collections.Generic.Dictionary<global::System.String, global::System.String> obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update__setting_possible_vals_index_dict_Values(obj.Values, phase);
                    }
                }
            }
            private void Update__setting_possible_vals_index_dict_Values(global::System.Collections.Generic.Dictionary<global::System.String, global::System.String>.ValueCollection obj, int phase)
            {
            ...
            private void UpdateTwoWay_5_SelectedIndex()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot._setting_current_vals != null)
                        {
                            this.dataRoot._setting_current_vals.ac_value = (this.obj5.Target as global::Microsoft.UI.Xaml.Controls.ComboBox).SelectedIndex;
                        }
                    }
                }
            }
            ...
            case 14: // Pages\Page1.xaml line 137
                {
                    ...
                    ((global::Microsoft.UI.Xaml.Input.KeyboardAccelerator)element14).Invoked += this.CtrlF_Invoked;
                }
                break;
            case 15: // Pages\Page1.xaml line 92
                {
